...
public class MethodLoggingAspect {
    ...
    @Before("@annotation(uz.consortgroup.user_service.asspect.annotation.LoggingAspectBeforeMethod)")
    ...
    @After("@annotation(uz.consortgroup.user_service.asspect.annotation.LoggingAspectAfterMethod)")
