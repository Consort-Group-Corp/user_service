...
import uz.consortgroup.userservice.cache.UserCache;
...
class UserServiceTest {
    ...
    void registerNewUser_ValidData_ReturnsUserResponse() {
        ...
        when(passwordEncoder.encode(eq(dto.getPassword()))).thenReturn("encodedPassword");
        ...
        verify(passwordEncoder).encode(eq(dto.getPassword()));
